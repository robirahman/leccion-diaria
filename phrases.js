...
// 17 situations, 260+ phrases with replies, formality, and cultural notes
...
const PHRASES_SITUATIONS = [
  ...
  { slug: 'debates', title: 'Debates y Argumentos', titleEn: 'Debates & Arguments', icon: '⚖️', desc: 'Express nuanced opinions and counterarguments (C1)' },
...
const PHRASES_DATA = [
  ...
  // ============================================================
  // 14. DEBATES — Debates y Argumentos (C1)
  // ============================================================
  {
    id: 'debate-1',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Entiendo su postura, pero permítame explicar.', english: 'I understand your position, but allow me to explain.' },
  },
  {
    id: 'debate-2',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Precisamente por eso debemos analizar ambos lados.', english: 'That is precisely why we must analyze both sides.' },
  },
  {
    id: 'debate-3',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Tiene razón, estoy simplificando demasiado.', english: 'You are right, I am oversimplifying.' },
  },
  {
    id: 'debate-4',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: '¿Podría citar las fuentes en las que se basa?', english: 'Could you cite the sources you are basing this on?' },
  },
  {
    id: 'debate-5',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Gracias. Entonces, ¿en qué discrepamos exactamente?', english: 'Thank you. So, what exactly do we disagree on?' },
  },
  {
    id: 'debate-6',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Adelante, le escucho.', english: 'Go ahead, I am listening.' },
  },
  {
    id: 'debate-7',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál sería el enfoque correcto, según usted?', english: 'What would the correct approach be, in your opinion?' },
  },
  {
    id: 'debate-8',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Actualicemos los datos antes de continuar.', english: 'Let us update the data before continuing.' },
  },
  {
    id: 'debate-9',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'No digo que lo invalide, sino que lo contextualiza.', english: 'I am not saying it invalidates it, but rather that it contextualizes it.' },
  },
  {
    id: 'debate-10',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: '¿A qué variables se refiere concretamente?', english: 'Which variables are you referring to specifically?' },
  },
  {
    id: 'debate-11',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Eso depende de cómo evaluemos las consecuencias.', english: 'That depends on how we evaluate the consequences.' },
  },
  {
    id: 'debate-12',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Me interesa escuchar esa interpretación alternativa.', english: 'I am interested in hearing that alternative interpretation.' },
  },
  {
    id: 'debate-13',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Quizás deberíamos buscar puntos en común.', english: 'Perhaps we should look for common ground.' },
  },
  {
    id: 'debate-14',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Propongo que retomemos el tema desde el principio.', english: 'I propose we revisit the topic from the beginning.' },
  },
  {
    id: 'debate-15',
    situation: 'debates',
    ...
    formality: 'formal',
    reply: { spanish: 'Estoy abierto a negociar si hay voluntad por ambas partes.', english: 'I am open to negotiating if there is willingness on both sides.' },
  },

  // ============================================================
  // 15. ACADEMIC — Presentaciones Académicas (C1)
  // ============================================================
  {
    id: 'academic-1',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: 'Un objetivo muy pertinente para el contexto actual.', english: 'A very pertinent objective for the current context.' },
  },
  {
    id: 'academic-2',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Podría mostrarnos los datos brutos primero?', english: 'Could you show us the raw data first?' },
  },
  {
    id: 'academic-3',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Con qué nivel de confianza estadística?', english: 'With what level of statistical confidence?' },
  },
  {
    id: 'academic-4',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuándo esperan tener los resultados definitivos?', english: 'When do you expect to have the definitive results?' },
  },
  {
    id: 'academic-5',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Por qué descartaron un enfoque puramente cuantitativo?', english: 'Why did you rule out a purely quantitative approach?' },
  },
  {
    id: 'academic-6',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿A qué atribuyen esa tendencia?', english: 'What do you attribute that trend to?' },
  },
  {
    id: 'academic-7',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál fue el tamaño de la muestra?', english: 'What was the sample size?' },
  },
  {
    id: 'academic-8',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Correlación implica causalidad en este caso?', english: 'Does correlation imply causality in this case?' },
  },
  {
    id: 'academic-9',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: 'Una conclusión bien fundamentada.', english: 'A well-founded conclusion.' },
  },
  {
    id: 'academic-10',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: 'Tengo una pregunta sobre la metodología.', english: 'I have a question about the methodology.' },
  },
  {
    id: 'academic-11',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: 'Gracias. ¿Podría desarrollar su respuesta?', english: 'Thank you. Could you elaborate on your answer?' },
  },
  {
    id: 'academic-12',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: 'Sí, por favor, no quedó del todo claro.', english: 'Yes, please, it was not entirely clear.' },
  },
  {
    id: 'academic-13',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo controlaron las variables secundarias?', english: 'How did you control for secondary variables?' },
  },
  {
    id: 'academic-14',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Hay estudios previos que respalden estos resultados?', english: 'Are there previous studies that support these results?' },
  },
  {
    id: 'academic-15',
    situation: 'academic',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál considera la más prometedora?', english: 'Which do you consider the most promising?' },
  },

  // ============================================================
  // 16. NEGOTIATIONS — Negociaciones (C2)
  // ============================================================
  {
    id: 'negotiations-1',
    ...
    formality: 'formal',
    reply: { spanish: '¿Qué plazos tenían en mente?', english: 'What deadlines did you have in mind?' },
  },
  {
    id: 'negotiations-2',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Depende de las condiciones. ¿Qué propone exactamente?', english: 'It depends on the conditions. What exactly do you propose?' },
  },
  {
    id: 'negotiations-3',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: '¿Qué tipo de garantías solicitan?', english: 'What type of guarantees are you requesting?' },
  },
  {
    id: 'negotiations-4',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Es una oferta interesante. Permítanos evaluarla.', english: 'That is an interesting offer. Allow us to evaluate it.' },
  },
  {
    id: 'negotiations-5',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Estamos abiertos a escucharla.', english: 'We are open to hearing it.' },
  },
  {
    id: 'negotiations-6',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Entendemos. ¿Hay otros puntos donde sí haya flexibilidad?', english: 'We understand. Are there other points where there is flexibility?' },
  },
  {
    id: 'negotiations-7',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Coincidimos en ese objetivo. Avancemos.', english: 'We agree on that objective. Let us move forward.' },
  },
  {
    id: 'negotiations-8',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: '¿En qué consiste exactamente?', english: 'What exactly does it consist of?' },
  },
  {
    id: 'negotiations-9',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Apreciamos esa concesión. Nosotros también cederemos en algo.', english: 'We appreciate that concession. We will also yield on something.' },
  },
  {
    id: 'negotiations-10',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Revisemos las condiciones una por una.', english: 'Let us review the conditions one by one.' },
  },
  {
    id: 'negotiations-11',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Nuestro departamento legal revisará los términos finales.', english: 'Our legal department will review the final terms.' },
  },
  {
    id: 'negotiations-12',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Por supuesto. La cláusula de rescisión queda clara.', english: 'Of course. The rescission clause is clear.' },
  },
  {
    id: 'negotiations-13',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'Excelente. Redactaremos el documento final.', english: 'Excellent. We will draft the final document.' },
  },
  {
    id: 'negotiations-14',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuánto tiempo necesitarían aproximadamente?', english: 'How much time would you need approximately?' },
  },
  {
    id: 'negotiations-15',
    situation: 'negotiations',
    ...
    formality: 'formal',
    reply: { spanish: 'En ese caso, necesitamos consultarlo internamente antes de responder.', english: 'In that case, we need to consult internally before responding.' },
  },

  // ============================================================
  // 17. LITERARY — Discusión Literaria (C2)
  // ============================================================
  {
    id: 'literary-1',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo se manifiestan esos temas en la trama?', english: 'How do those themes manifest in the plot?' },
  },
  {
    id: 'literary-2',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cree que eso enriquece o dificulta la lectura?', english: 'Do you think that enriches or hinders the reading?' },
  },
  {
    id: 'literary-3',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: 'Sin duda, recuerda a García Márquez en ciertos pasajes.', english: 'Undoubtedly, it is reminiscent of Garcia Marquez in certain passages.' },
  },
  {
    id: 'literary-4',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Diría que se trata de un arco de redención?', english: 'Would you say it is a redemption arc?' },
  },
  {
    id: 'literary-5',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: 'Es un tópico clásico que aquí adquiere un matiz original.', english: 'It is a classic trope that here acquires an original nuance.' },
  },
  {
    id: 'literary-6',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál es su interpretación personal del final?', english: 'What is your personal interpretation of the ending?' },
  },
  {
    id: 'literary-7',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: 'Sí, hay pasajes que rayan en lo lírico.', english: 'Yes, there are passages that border on the lyrical.' },
  },
  {
    id: 'literary-8',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿A qué problemática social se refiere concretamente?', english: 'Which social issue are you referring to specifically?' },
  },
  {
    id: 'literary-9',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿En qué momentos detecta esa falta de fiabilidad?', english: 'At what moments do you detect that unreliability?' },
  },
  {
    id: 'literary-10',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Hasta qué punto condiciona el contexto la interpretación?', english: 'To what extent does the context condition the interpretation?' },
  },
  {
    id: 'literary-11',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Podría compartir su lectura simbólica?', english: 'Could you share your symbolic reading?' },
  },
  {
    id: 'literary-12',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo resuelve el autor esa tensión, si es que lo hace?', english: 'How does the author resolve that tension, if at all?' },
  },
  {
    id: 'literary-13',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: 'Ese vaivén estilístico refleja la dualidad del protagonista.', english: 'That stylistic back-and-forth reflects the duality of the protagonist.' },
  },
  {
    id: 'literary-14',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Qué referencias intertextuales ha identificado?', english: 'What intertextual references have you identified?' },
  },
  {
    id: 'literary-15',
    situation: 'literary',
    ...
    formality: 'formal',
    reply: { spanish: '¿Qué la hace tan vigente para el lector contemporáneo?', english: 'What makes it so relevant for the contemporary reader?' },
  },

  // ============================================================
  // 18. DIPLOMACY — Lenguaje Diplomático (C1)
  // ============================================================
  {
    id: 'diplo-1',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Compartimos esa posición y estamos dispuestos a mediar.', english: 'We share that position and are willing to mediate.' },
  },
  {
    id: 'diplo-2',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Agradecemos el llamamiento y reafirmamos nuestro compromiso.', english: 'We appreciate the appeal and reaffirm our commitment.' },
  },
  {
    id: 'diplo-3',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Nos sumamos a esta condena y exigimos una investigación independiente.', english: 'We join this condemnation and demand an independent investigation.' },
  },
  {
    id: 'diplo-4',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Tomamos nota de su posición y solicitamos una sesión de consultas.', english: 'We take note of your position and request a consultation session.' },
  },
  {
    id: 'diplo-5',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Acogemos con satisfacción la propuesta y designaremos a nuestros representantes.', english: 'We welcome the proposal and will designate our representatives.' },
  },
  {
    id: 'diplo-6',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Esperamos que ese compromiso se traduzca en acciones concretas.', english: 'We hope that commitment translates into concrete actions.' },
  },
  {
    id: 'diplo-7',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Consideramos que la decisión fue necesaria y proporcionada.', english: 'We consider the decision to have been necessary and proportionate.' },
  },
  {
    id: 'diplo-8',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Apoyamos la convocatoria y presentaremos un proyecto de resolución.', english: 'We support the convening and will present a draft resolution.' },
  },
  {
    id: 'diplo-9',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Confiamos en que la diplomacia prevalecerá sobre la confrontación.', english: 'We trust that diplomacy will prevail over confrontation.' },
  },
  {
    id: 'diplo-10',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Coincidimos en que no hay alternativa a la vía diplomática.', english: 'We agree there is no alternative to the diplomatic path.' },
  },
  {
    id: 'diplo-11',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Nuestro canciller confirmó su asistencia a la ceremonia de firma.', english: 'Our foreign minister confirmed attendance at the signing ceremony.' },
  },
  {
    id: 'diplo-12',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Deploramos las violaciones del alto el fuego registradas hasta la fecha.', english: 'We deplore the ceasefire violations recorded to date.' },
  },
  {
    id: 'diplo-13',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Valoramos la coherencia de su política exterior en esta materia.', english: 'We value the coherence of your foreign policy on this matter.' },
  },
  {
    id: 'diplo-14',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Agradecemos la muestra de solidaridad y la ayuda humanitaria ofrecida.', english: 'We appreciate the show of solidarity and the humanitarian aid offered.' },
  },
  {
    id: 'diplo-15',
    situation: 'diplomacy',
    ...
    formality: 'formal',
    reply: { spanish: 'Reiteramos nuestra voluntad de acatar las resoluciones vigentes.', english: 'We reiterate our willingness to abide by the resolutions in force.' },
  },

  // ============================================================
  // 19. JOURNALISM — Periodismo (C1)
  // ============================================================
  {
    id: 'journal-1',
    ...
    formality: 'formal',
    reply: { spanish: '¿Puede revelar la identidad de esas fuentes?', english: 'Can you reveal the identity of those sources?' },
  },
  {
    id: 'journal-2',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Descarta entonces una remodelación del gabinete?', english: 'Does she then rule out a cabinet reshuffle?' },
  },
  {
    id: 'journal-3',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Hay un plazo estimado para la conclusión de la investigación?', english: 'Is there an estimated deadline for the conclusion of the investigation?' },
  },
  {
    id: 'journal-4',
    situation: 'journalism',
    ...
    formality: 'neutral',
    reply: { spanish: '¿Cuál ha sido la reacción de los principales líderes de opinión?', english: 'What has been the reaction of the main opinion leaders?' },
  },
  {
    id: 'journal-5',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Actualizarán la información en la edición digital?', english: 'Will you update the information in the digital edition?' },
  },
  {
    id: 'journal-6',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál es la situación sobre el terreno en estos momentos?', english: 'What is the situation on the ground at this moment?' },
  },
  {
    id: 'journal-7',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Se permitirán preguntas de los periodistas al finalizar?', english: 'Will questions from journalists be allowed at the end?' },
  },
  {
    id: 'journal-8',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿En qué fuentes estadísticas se basan esos datos?', english: 'What statistical sources are those data based on?' },
  },
  {
    id: 'journal-9',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuánto tiempo llevó la investigación?', english: 'How long did the investigation take?' },
  },
  {
    id: 'journal-10',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Ha habido alguna reacción oficial por parte de la institución?', english: 'Has there been any official reaction from the institution?' },
  },
  {
    id: 'journal-11',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuáles son las medidas más destacadas del plan?', english: 'What are the most notable measures of the plan?' },
  },
  {
    id: 'journal-12',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál es la postura del periódico al respecto?', english: 'What is the newspaper\'s stance on the matter?' },
  },
  {
    id: 'journal-13',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Han verificado la autenticidad de esos documentos?', english: 'Have you verified the authenticity of those documents?' },
  },
  {
    id: 'journal-14',
    situation: 'journalism',
    ...
    formality: 'neutral',
    reply: { spanish: '¿A qué atribuyen el aumento de audiencia?', english: 'What do you attribute the audience increase to?' },
  },
  {
    id: 'journal-15',
    situation: 'journalism',
    ...
    formality: 'formal',
    reply: { spanish: '¿Se ha abierto una investigación interna sobre el error?', english: 'Has an internal investigation been opened regarding the error?' },
  },

  // ============================================================
  // 20. PHILOSOPHY — Discurso Filosófico (C2)
  // ============================================================
  {
    id: 'philo-1',
    ...
    formality: 'formal',
    reply: { spanish: '¿No presupone eso ya una comprensión preontológica del ser?', english: 'Does that not already presuppose a pre-ontological understanding of Being?' },
  },
  {
    id: 'philo-2',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo distingue usted entre intencionalidad y mera representación?', english: 'How do you distinguish between intentionality and mere representation?' },
  },
  {
    id: 'philo-3',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No es precisamente esa circularidad lo que dota de autonomía a la razón?', english: 'Is it not precisely that circularity that grants reason its autonomy?' },
  },
  {
    id: 'philo-4',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Pero puede realmente universalizarse una máxima sin atender al contexto?', english: 'But can a maxim truly be universalized without attending to context?' },
  },
  {
    id: 'philo-5',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No simplifica eso en exceso el concepto de Aufhebung?', english: 'Does that not oversimplify the concept of Aufhebung?' },
  },
  {
    id: 'philo-6',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No ha mostrado la neurociencia que la autoconciencia es más frágil de lo que Descartes supuso?', english: 'Has neuroscience not shown that self-consciousness is more fragile than Descartes supposed?' },
  },
  {
    id: 'philo-7',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo evitar que el cuestionamiento nihilista desemboque en la parálisis?', english: 'How can one prevent nihilistic questioning from leading to paralysis?' },
  },
  {
    id: 'philo-8',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Es posible entonces una interpretación verdaderamente objetiva?', english: 'Is a truly objective interpretation possible, then?' },
  },
  {
    id: 'philo-9',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Considera usted viable alguna forma de monismo no reductivo?', english: 'Do you consider any form of non-reductive monism viable?' },
  },
  {
    id: 'philo-10',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No corremos el riesgo de caer en un particularismo moral?', english: 'Do we not run the risk of falling into moral particularism?' },
  },
  {
    id: 'philo-11',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Implica eso que el ser humano carece de naturaleza fija?', english: 'Does that imply that the human being lacks a fixed nature?' },
  },
  {
    id: 'philo-12',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No termina la deconstrucción deconstruyéndose a sí misma?', english: 'Does deconstruction not end up deconstructing itself?' },
  },
  {
    id: 'philo-13',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Es realista suponer que alguien puede abstraerse de su situación concreta?', english: 'Is it realistic to assume someone can abstract from their concrete situation?' },
  },
  {
    id: 'philo-14',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cómo se articula esa autoafirmación sin caer en el solipsismo?', english: 'How is that self-affirmation articulated without falling into solipsism?' },
  },
  {
    id: 'philo-15',
    situation: 'philosophy',
    ...
    formality: 'formal',
    reply: { spanish: '¿No cae eso en un relativismo epistemológico?', english: 'Does that not fall into epistemological relativism?' },
  },

  // ============================================================
  // 21. LEGAL — Lenguaje Jurídico (C2)
  // ============================================================
  {
    id: 'legal-1',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'Puede usted proceder, letrado.', english: 'You may proceed, counsel.' },
  },
  {
    id: 'legal-2',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'La fiscalía se reserva el derecho a recurrir la sentencia.', english: 'The prosecution reserves the right to appeal the sentence.' },
  },
  {
    id: 'legal-3',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Procede la restitución de las prestaciones realizadas?', english: 'Is restitution of the performed obligations in order?' },
  },
  {
    id: 'legal-4',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'El plazo para la interposición del recurso expira en cinco días hábiles.', english: 'The deadline for filing the appeal expires in five working days.' },
  },
  {
    id: 'legal-5',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'Se cita a las partes a declarar en un plazo de diez días.', english: 'The parties are summoned to testify within ten days.' },
  },
  {
    id: 'legal-6',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'El tribunal desestima la alegación y ordena proseguir con la vista.', english: 'The court dismisses the allegation and orders the hearing to continue.' },
  },
  {
    id: 'legal-7',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuáles son las condiciones impuestas durante el período de suspensión?', english: 'What are the conditions imposed during the suspension period?' },
  },
  {
    id: 'legal-8',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: 'La defensa solicitará la revisión de la medida cautelar.', english: 'The defence will request a review of the precautionary measure.' },
  },
  {
    id: 'legal-9',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿A qué sentencia en concreto hace referencia el letrado?', english: 'Which specific ruling is counsel referring to?' },
  },
  {
    id: 'legal-10',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Se mantienen las medidas cautelares hasta la próxima sesión?', english: 'Are the precautionary measures maintained until the next session?' },
  },
  {
    id: 'legal-11',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Puede el perito aclarar la metodología empleada en su informe?', english: 'Can the expert clarify the methodology used in the report?' },
  },
  {
    id: 'legal-12',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Existe alguna causa que haya podido interrumpir la prescripción?', english: 'Is there any cause that may have interrupted the limitation period?' },
  },
  {
    id: 'legal-13',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Tiene el acta notarial fuerza probatoria en este procedimiento?', english: 'Does the notarial deed have evidentiary force in this proceeding?' },
  },
  {
    id: 'legal-14',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Cuál es la cuantía fijada en concepto de indemnización?', english: 'What is the amount set as compensation?' },
  },
  {
    id: 'legal-15',
    situation: 'legal',
    ...
    formality: 'formal',
    reply: { spanish: '¿Qué artículo de la Constitución considera vulnerado la parte recurrente?', english: 'Which article of the Constitution does the appellant consider violated?' },
  },
];
