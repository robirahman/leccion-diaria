...
(function (root, factory) {
  ...
  var api = {
    ...
    data: {
      ...
      // Content modules
      get reading()              { return ref('READING_DATA'); },
      get readingSat()           { return ref('READING_SAT_DATA'); },
      get cloze()                { return ref('CLOZE_PASSAGES'); },
      get dictation()            { return ref('DICTATION_DATA'); },
      get sentenceConstruction() { return ref('SENTENCE_CONSTRUCTION'); },
      get translationDrills()    { return ref('TRANSLATION_DRILLS'); },
      get branchingDialogues()   { return ref('BRANCHING_DIALOGUES'); },
      get minimalPairCategories(){ return ref('MINIMAL_PAIR_CATEGORIES'); },
      get minimalPairs()         { return ref('MINIMAL_PAIRS'); },
      get phoneticPairCategories(){ return ref('PHONETIC_PAIR_CATEGORIES'); },
      get phoneticPairs()        { return ref('PHONETIC_PAIRS'); },
      get homophoneCategories()  { return ref('HOMOPHONE_CATEGORIES'); },
      get homophones()           { return ref('HOMOPHONES'); },
      get connectorCategories()  { return ref('CONNECTOR_CATEGORIES'); },
      get connectors()           { return ref('CONNECTORS'); },
      // Cultural modules
      get recipes()              { return ref('RECIPES_DATA'); },
      get music()                { return ref('MUSIC_DATA'); },
      get movies()               { return ref('MOVIES_DATA'); },
      get poetry()               { return ref('POETRY_DATA'); },
      get sports()               { return ref('SPORTS_DATA'); },
      get proverbs()             { return ref('PROVERBS_DATA'); },
      get folktales()            { return ref('FOLKTALES_DATA'); },
      get festivals()            { return ref('FESTIVALS_DATA'); },
      get history()              { return ref('HISTORY_DATA'); },
